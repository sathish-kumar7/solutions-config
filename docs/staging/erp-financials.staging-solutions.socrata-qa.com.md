...
|--------- |--------- |
 ...
 | Measure Name | SoQL Query | Example Link | Approximate Query Time (in seconds) |
|--------- |--------- |--------- |--------- |
 | Applicants per Open Position | `SELECT AVG(applicant_id)` | [https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=SELECT AVG\(applicant_id\)](https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=SELECT%20AVG%28applicant_id%29) | 0.32 |
 ## Time to Hire 
 Dataset Link: erpinsights.demo.socrata.com/d/n5zv-gf3k
 #### Data Dimensions
...
|--------- |--------- |
 ...
 | Measure Name | SoQL Query | Example Link | Approximate Query Time (in seconds) |
|--------- |--------- |--------- |--------- |
 | Time to Hire | `select * where acceptedposition = 'true'   \|>   SELECT AVG(date_diff_d(betterhiredate, positionopendate))` | [https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=select * where acceptedposition = 'true' \|> SELECT AVG\(date_diff_d\(betterhiredate, positionopendate\)\)](https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=select%20%2A%20where%20acceptedposition%20%3D%20%27true%27%20%7C%3E%20SELECT%20AVG%28date_diff_d%28betterhiredate%2C%20positionopendate%29%29) | 0.67 |