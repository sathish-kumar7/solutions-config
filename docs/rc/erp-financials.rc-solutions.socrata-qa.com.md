...
|--------- |--------- |
 ...
 | Measure Name | SoQL Query | Example Link | Approximate Query Time (in seconds) |
|--------- |--------- |--------- |--------- |
 | Revenue vs. Budget | `SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=SELECT%20SUM%28actual%29) | 0.78 |
 | Tax Revenue vs. Budget | `select * where charactercodedescription = 'Local Taxes'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where charactercodedescription = 'Local Taxes' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20charactercodedescription%20%3D%20%27Local%20Taxes%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 1.03 |
 | Water Resources Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.51 |
 | Sewer Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   select * where segment3 = 'Sewer'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> select * where segment3 = 'Sewer' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20select%20%2A%20where%20segment3%20%3D%20%27Sewer%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.58 |
 | Water Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   select * where segment3 = 'Water'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> select * where segment3 = 'Water' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20select%20%2A%20where%20segment3%20%3D%20%27Water%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.75 |
 | Stormwater Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   select * where segment3 = 'Stormwater'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> select * where segment3 = 'Stormwater' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20select%20%2A%20where%20segment3%20%3D%20%27Stormwater%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.51 |
