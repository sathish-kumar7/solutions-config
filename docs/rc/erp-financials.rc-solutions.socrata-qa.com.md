...
|--------- |--------- |
 ...
 | Measure Name | SoQL Query | Example Link | Approximate Query Time (in seconds) |
|--------- |--------- |--------- |--------- |
 | Revenue vs. Budget | `SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=SELECT%20SUM%28actual%29) | 0.7 |
 | Tax Revenue vs. Budget | `select * where charactercodedescription = 'Local Taxes'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where charactercodedescription = 'Local Taxes' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20charactercodedescription%20%3D%20%27Local%20Taxes%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.84 |
 | Water Resources Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.58 |
 | Sewer Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.86 |
 | Water Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.94 |
 | Stormwater Revenues vs. Budget | `select * where entity = 'Water Resources'   \|>   SELECT SUM(actual)` | [https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select * where entity = 'Water Resources' \|> SELECT SUM\(actual\)](https://murfreesboro.data.socrata.com/resource/wiba-zbm5.json?$query=select%20%2A%20where%20entity%20%3D%20%27Water%20Resources%27%20%7C%3E%20SELECT%20SUM%28actual%29) | 0.58 |
...
|--------- |--------- |
 ...
 | Measure Name | SoQL Query | Example Link | Approximate Query Time (in seconds) |
|--------- |--------- |--------- |--------- |
 | Applicants per Open Position | `SELECT AVG(applicant_id)` | [https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=SELECT AVG\(applicant_id\)](https://erpinsights.demo.socrata.com/resource/n5zv-gf3k.json?$query=SELECT%20AVG%28applicant_id%29) | 0.39 |
 ## Time to Hire 
 Dataset Link: erpinsights.demo.socrata.com/d/n5zv-gf3k
 #### Data Dimensions
