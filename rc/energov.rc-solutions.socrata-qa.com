  ...
  "template_entries": [
    {
      ...
      "view_entries": [
        ...
        },
        {
          ...
          "parent_queries": [
            "select location, applicationdate, permitnumber, permittypegroup, permitstatus, permitworkclass, capital_fund_project,projectname, district, applied_to_issued, case(applied_to_issued < 90, 1) as less_than_90_count where isstatusissued='true'"
          ],
          "target_entries": [
            {
              "name": "SLA Met",
